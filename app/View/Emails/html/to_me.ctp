                    ...
                    <td style="padding-top:0;padding-bottom:0;padding-right:0;padding-left:0;">
                                    ...
                                    <table style="width:100%;border-spacing:0;font-family:Arial, sans-serif;color:#607D8B;">
                                        ...
                                        <tr>
                                            <td style="color:#ffffff;font-weight:500;font-size:17px;padding-bottom:0;padding-right:0;padding-left:0;padding-top:0; text-align:center;">
                                                New Registration On Our Portal
                                            </td>
                                        </tr>
                                    </table>
                                    <br />
                                ...
                                <table width="100%" style="border-spacing:0;font-family:Arial, sans-serif;color:#607D8B;">
                                    <tr>
                                        <td class="inner contents" style="padding-top:10px;padding-bottom:20px;padding-right:10px;padding-left:10px;width:100%;text-align:left;">
                                            <p class="h1" style="margin-top:0;margin-right:0;margin-left:0;line-height:21px;font-weight:bold;font-size:16px;margin-bottom:10px;">Dear Vikrant,</p>
                                            <p style="margin-top:0;margin-right:0;margin-left:0;line-height:21px;font-size:16px;margin-bottom:10px;">
                                                This is inform you that a new user is creted on our portal below th details.
                                            </p>
                                            <br/>
                        ...
                        <tr>
                            <td class="one-column" style="padding-top:0;padding-bottom:0;padding-right:0;padding-left:0;">
                                <table width="100%" style="border-spacing:0;font-family:Arial, sans-serif;color:#607D8B;">
                                    <tr>
                                        <td class="inner contents" style="text-align:left;padding-bottom:10px;padding-top:10px;padding-right:10px;padding-left:10px;width:100%;background-color:#E0E0E4;color:#6B6B6B;font-size:18px; font-weight:600; line-height: 26px;">
                                            Details:
                                            <p>Name : <?php echo $message['name'];?></p>
                                            <p>Login : <?php echo $message['email'];?></p>
                                        </td>
                                    </tr>
